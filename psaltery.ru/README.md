...
```
Анализ метаданных показал, что на сайте содержится много разных файлов. Это объясняется тем, что wpull скачал по сути два сайта: первый (psaltery.ru) - статический, очень простой, и второй (на поддомене gusli.psaltery.ru) - с более сложной динамической структурой. 58% места в архиве занимают видеозаписи (все они расположены на поддоменном сайте), 38% – фото в разных форматах, на текст приходится 1%.
